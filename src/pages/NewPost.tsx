        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-spring-700 mt-2">Share your knowledge with the world</p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="A brief description of your post (will be generated from content if left empty)..."
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  ...
                  />
                  <Button type="button" onClick={handleAddTag} variant="outline" className="border-spring-300 hover:bg-spring-100">
                    Add Tag
                  </Button>
                </div>
                {tagList.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {tagList.map((tag) => (
                      <Badge key={tag} variant="outline" className="border-spring-300 bg-white/50">
                        {tag}
                        <button
                          type="button"
